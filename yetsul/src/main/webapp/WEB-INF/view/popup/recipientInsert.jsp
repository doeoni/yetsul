...
<section>
	...
	<div align="center">
		...
		<hr width="80%">
		<br>
		<form name="f" action="${path}/popup/recipientInsertOK.do" method="post" onsubmit="return recipientCheck();">
			...
			<table style="font-size: small">
				...
				<tr>
					<td align="left" colspan=3 style="border-top: hidden; border-bottom: hidden;">
						&emsp;<input type="text" id="address" size=50 name="recipientAddr1">
					</td>
				</tr>
				<tr>
					<td colspan=3>
						&emsp;<input type="text" id="detailAddress" size=25 name="recipientAddr2">
			...
			<br><br>
			<input type="button" value="이 전" onclick="location.href='${path}/popup/recipientList.do'">
